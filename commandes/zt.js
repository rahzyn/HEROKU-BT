...
zokou({
  ...
  try {
    if (!args || args.length === 0) {
      return respond("Usage example: .pair 255693629079.");
    }
...
zokou({
  ...
  try {
    if (!_0xea7c04 || _0xea7c04.length === 0x0) {
      return _0x5e569a("Hello am *HEROKU-BT.* an AI developed by Rahmani .\n\n What help can I offer you today?");
    }
  ...
  try {
    ...
    if (_0x823fc2 && _0x823fc2.message && _0x823fc2.message.content) {
      ...
      const _0x16ed68 = [{
        'name': "cta_url",
        'buttonParamsJson': JSON.stringify({
          'display_text': "FOLLOW 𝐦𝐲 CHANNEL",
